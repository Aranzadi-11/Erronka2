...
public class ProduktuaApp {
    public static void main(String[] args) {
        ...
        // Karritoa sortu eta produktuak gehitu
        Karritoa karritoa = new Karritoa();
        karritoa.produktuaGehitu(produktua1);
        karritoa.produktuaGehitu(produktua2);
        karritoa.produktuaGehitu(produktua3);
        karritoa.produktuaGehitu(produktua4);

        // Karritoaren informazioa erakutsi
        System.out.println("\nKarritoaren informazioa:");
        System.out.println("Produktu kopurua karritoan: " + karritoa.getProduktuenKantitatea());
        System.out.println("Prezio totala karritoan: " + karritoa.getPrezioTotala() + " €");

        // Produktu bat kendu eta berriro erakutsi informazioa
        karritoa.produktuaKendu(produktua2);
        karritoa.produktuaKendu(produktua3);
        System.out.println("\nKarritoaren informazioa:");
        System.out.println("Produktu kopurua karritoan: " + karritoa.getProduktuenKantitatea());
        System.out.println("Prezio totala karritoan: " + karritoa.getPrezioTotala() + " €");
    }
